#pragma once
/*
After every cs:go update the offsets will change and you will need to update them again, you can get the new ones from hazedumper, keep in
mind hazedumper github 
sometimes takes a day or two to update.
...
#define dwForceAttack  0x322DDE8
#define dwForceAttack2  0x322DDF4
#define dwForceBackward  0x322DE30
#define dwForceForward  0x322DE24
#define dwForceJump  0x52BBCD8
#define dwForceLeft  0x322DDA0
#define dwForceRight  0x322DDAC
#define dwGameDir  0x63AD80
#define dwGameRulesProxy  0x532F4E4
#define dwGetAllClasses  0xE0BF94
#define dwGlobalVars  0x59EE60
#define dwGlowObjectManager  0x535AA08
#define dwInput  0x525D550
#define dwInterfaceLinkList  0x99B4A4
#define dwLocalPlayer  0xDEA98C
#define dwMouseEnable  0x52391B0
#define dwMouseEnablePtr  0x5239180
#define dwPlayerResource  0x322C120
#define dwRadarBase  0x5236A54
#define dwSensitivity  0xDEEBA8
#define dwSensitivityPtr  0xDEEBA8
#define dwSetClanTag  0x8DA80
#define dwViewMatrix  0x4DF0DC4
#define dwWeaponTable  0x525E62C
#define dwWeaponTableIndex  0x326C
#define dwYawPtr  0xDEE938
#define dwZoomSensitivityRatioPtr  0xDF43A8
#define dwbSendPackets  0xDD2B2
#define dwppDirect3DDevice9  0xA62C0
#define find_hud_element  0x58B402D0
#define force_update_spectator_glow  0x3D997A
#define interface_engine_cvar  0x3FA9C
#define is_c4_owner  0x3E71A0
#define m_bDormant  0xED
#define m_bIsLocalPlayer  0x3628
#define m_flSpawnTime  0x103C0
#define m_pStudioHdr  0x2950
#define m_pitchClassPtr  0x52390A8
#define m_yawClassPtr  0xDEE938
#define model_ambient_min  0x5A1194
#define set_abs_angles  0x1E7A10
#define set_abs_origin  0x1E7850